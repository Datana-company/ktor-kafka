...
include(":dsmart-module-converter:dsmart-module-converter-backend")
...
include(":dsmart-module-converter:dsmart-module-converter-models-extevent")
...
include("dsmart-module-converter:dsmart-module-converter-repo-inmemory")
