...
fun toConverterTransportExtendEvents(record: InnerRecord<String, String>): ConverterTransportExtendEvent {
    try {
        return jacksonSerializer.readValue(record.value, ConverterTransportExtendEvent::class.java)!!
    } catch (e: Exception) {
        throw ConverterDeserializationException(e.message, e.cause)
    }
}
