...
fun ConverterAngContext.of(item: ConsumerItem<String, String>): ConverterAngContext {
...
fun fromConsumerItem(item: ConsumerItem<String, String>): ConverterMeltInfo {
    try {
        ...
        throw ConverterDeserializationException(e.message, e.cause, item.value)
    }
}

fun ConverterAngContext.setMeltInfo(converterMeltInfo: ConverterMeltInfo) {
