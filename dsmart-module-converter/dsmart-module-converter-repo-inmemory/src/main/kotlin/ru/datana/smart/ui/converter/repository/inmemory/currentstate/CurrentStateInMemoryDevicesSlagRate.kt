...
import ru.datana.smart.ui.converter.common.models.ModelDevicesSlagRate

data class CurrentStateInMemoryDevicesSlagRate(
    ...
    fun toModel() = ModelDevicesSlagRate(
        id = id?: "",
        name = name?: "",
        uri = uri?: "",
        deviceType = deviceType?: "",
    ...
    companion object {
        fun of(model: ModelDevicesSlagRate) = CurrentStateInMemoryDevicesSlagRate(
