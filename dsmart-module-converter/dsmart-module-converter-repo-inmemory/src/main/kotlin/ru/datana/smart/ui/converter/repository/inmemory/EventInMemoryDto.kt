...
data class EventInMemoryDto(
    ...
    var timeFinish: Long = Long.MIN_VALUE,
    var title: String = "",
    var textMessage: String = "",
    var category: ModelEvent.Category = ModelEvent.Category.NONE,
...
//    val criticalPoint: Double? = null
    ...
    fun toModel(): ModelEvent = ModelEvent(
        ...
        type = type,
        meltId = meltId,
        timeStart = Instant.ofEpochMilli(timeStart),
        timeFinish = Instant.ofEpochMilli(timeFinish),
        title = title,
